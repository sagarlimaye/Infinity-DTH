...
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><a href="HomeController?option=EditChannel&id=${channel.channel_id}">Edit</a></td>
                    <td><a href="HomeController?option=RemoveChannel&id=${channel.channel_id}">Remove</a></td>
