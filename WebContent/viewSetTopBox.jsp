...
<div align="center" class="add-container">
	<button onclick="location.href = '/InfinityDTH/HomeController?option=PrepareCreateSetTopBox';" id="myButton" class="btn btn-primary float-none submit-button" >Add SetTop Box</button>
</div>
